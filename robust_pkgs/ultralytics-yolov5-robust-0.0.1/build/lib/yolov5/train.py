...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default=Path.cwd() / 'yolov5s.pt', help='initial weights path')
    ...
    parser.add_argument('--project', default=Path.cwd() / 'runs/train', help='save to project/name')
